...
namespace JugaAgenda_v2
{
    ...
    public class GoogleCalendar
    {
        ...
        private SyncCalendar workCalendar;
        private SyncCalendar leaveCalendar;
        ...
        {
            return workCalendar.addEvent(new_event);
        ...
        {
            return workCalendar.editEvent(new_event);
        ...
        {
            return workCalendar.deleteEvent(eventID);
